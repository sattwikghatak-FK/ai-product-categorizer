...
const TAXONOMY = {
  ...
  "Men's Clothing": {
    ...
    "Jackets & Hoodies":          ["men jacket","men hoodie","men sweatshirt","men pullover","men blazer","men coat","men windcheater"],
    "Innerwear & Socks":          ["men brief","men boxer","men trunk","men vest","men innerwear","men socks","ankle socks","men underwear"],
    "Activewear":                 ["men track pant","men jogger","men gym wear","men shorts","gym t-shirt","compression tights"],
    "Winterwear":                 ["men sweater","men cardigan","men pullover","men thermal","men muffler","men woollen","men fleece"],
  },
  "Women's Clothing": {
    "Tops & Blouses":             ["women top","ladies top","women blouse","crop top","cami top","women tunic","women shirt","off shoulder","peplum top","halter top","tank top women"],
    ...
    "Dresses":                    ["women dress","maxi dress","midi dress","mini dress","bodycon","wrap dress","shirt dress","sundress","floral dress women"],
    "Jeans & Trousers":           ["women jeans","ladies jeans","women trouser","palazzo","women chinos","women denim","skinny jeans","bootcut jeans"],
    "Innerwear & Lingerie":       ["bra","panty","women brief","lingerie","shapewear","sports bra","bralette","padded bra","women innerwear"],
    ...
    "Jackets & Shrugs":           ["women jacket","shrug","women hoodie","women blazer","women cardigan","women coat","women sweatshirt"],
    "Winterwear":                 ["women sweater","women woollen","women thermal","women muffler","women shawl","women stole","women fleece"],
  },
  "Kids Footwear": {
    "Casual Shoes":               ["casual shoes","velcro shoes","kids casual","slip on shoes","kids sneaker","canvas shoes kids","children shoes","printed shoes","animal print shoes","floral shoes"],
    "Sandals & Slippers":         ["kids sandal","baby sandal","kids slipper","velcro sandal","solid sandal","cap toe sandal","strap sandal","kids chappal","infant sandal"],
    "Formal & Party Shoes":       ["formal shoes kids","party shoes kids","slip on formal","kids loafer","dress shoes kids","bow shoes"],
    ...
    "First Walker":               ["first walker","baby walker shoe","infant shoe","newborn shoe","toddler shoe","soft sole"],
  },
  "Men's Footwear": {
    "Sneakers & Sports":          ["men sneaker","men sports shoe","running shoe","men trainers","men canvas","athletic shoe men"],
    "Formal Shoes":               ["men formal shoe","men oxford","men derby","men brogue","men loafer","men dress shoe"],
    "Sandals & Slippers":         ["men sandal","men slipper","men flip flop","men chappal","men slide","men kolhapuri"],
    "Boots":                      ["men boot","men ankle boot","men chelsea boot","men combat boot","men hiking boot"],
  },
  "Women's Footwear": {
    "Heels & Wedges":             ["women heel","stiletto","wedge heel","block heel","kitten heel","platform heel","women pump"],
    "Flats & Ballerinas":         ["ballerina","women flat","women ballet","pointed flat","women slip on"],
    "Sandals":                    ["women sandal","ladies sandal","strappy sandal","kolhapuri women","women chappal","anklet sandal"],
    ...
    "Boots":                      ["women boot","women ankle boot","women knee boot","women chelsea"],
  },
  ...
  "Books & Learning": {
    ...
    "Educational Books":          ["textbook","guide book","workbook","practice book","olympiad","science book","math book","cbse","ncert","reference book"],
    "Adult Books":                ["novel","fiction","non-fiction","biography","autobiography","self help","business book","thriller","romance novel","mystery","history book","cookbook"],
